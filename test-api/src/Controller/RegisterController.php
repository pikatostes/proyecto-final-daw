...
public function register(Request $request, EntityManagerInterface $entityManager, UserPasswordHasherInterface $passwordHasher): JsonResponse
{
    ...
    if (!$email || !$username || !$password || (!$avatar && !$avatarUrl)) {
        return new JsonResponse(['error' => 'Email, username, password, and avatar or avatarUrl are required'], Response::HTTP_BAD_REQUEST);
    }
    ...
    return new JsonResponse(['message' => 'User registration successful'], Response::HTTP_OK);
}
